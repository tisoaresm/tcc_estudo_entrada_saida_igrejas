...
# Reestruturar os dados com pivot_wider para verificar qual denominacao predominante em cada condado
...
plot_map <- function(dados, shapefile, ano, lim_lat, lim_lon, output_dir) {
  # Filtrar dados para o ano especifico
