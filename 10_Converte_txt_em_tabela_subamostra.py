...
caminho = 'subamostra_de_condados//Outputs_Regressoes'
...
def needs_more_than_five_decimals(number_str):
    ...
    # Ajuste para remover a notação científica e obter a precisão total
    number_str_full = f"{number:.30f}".rstrip('0').rstrip('.')
    # Contar os dígitos após o ponto decimal
