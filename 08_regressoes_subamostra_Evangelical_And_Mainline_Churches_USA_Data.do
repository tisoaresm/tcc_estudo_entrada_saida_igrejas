...
use grpcode year fipsmerg cntynm stateab pop_em_milhoes grpname adherent congreg reltrad family a_imt a_imt_1 prev_year n_E n_M n_C ano_mercado Evangelical Mainline Catholic using "subamostra_de_condados\Bases_Filtradas\Evangelical_And_Mainline_Churches_USA_Data.dta"
...
if _rc == 0 {
    outreg2 using "subamostra_de_condados\Outputs_Regressoes\Regression_reghdfe_Model1_Evangelical_And_Mainline_Churches_USA_Data.txt", replace
} 
else {
...
* Salvar os resultados em um arquivo de texto
if _rc == 0 {
    outreg2 using "subamostra_de_condados\Outputs_Regressoes\Regression_reghdfe_Model2_Evangelical_And_Mainline_Churches_USA_Data.txt", replace
} 
else {
...
* Salvar os resultados em um arquivo de texto
if _rc == 0 {
    outreg2 using "subamostra_de_condados\Outputs_Regressoes\Regression_reghdfe_Model3_Evangelical_And_Mainline_Churches_USA_Data.txt", replace
} 
else {
...
* Salvar os resultados em um arquivo de texto
if _rc == 0 {
    outreg2 using "subamostra_de_condados\Outputs_Regressoes\Regression_reghdfe_Model4_Evangelical_And_Mainline_Churches_USA_Data.txt", replace
} 
else {
